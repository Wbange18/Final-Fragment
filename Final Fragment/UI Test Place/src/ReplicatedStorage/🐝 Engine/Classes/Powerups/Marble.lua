...
function Marble:Run()
	...
	self.Animation = Engine.Tools:QuickAnimation(self.Handle.Animation)
	self.Animation:AdjustSpeed(0)
	Engine.Tools:QuickTween(self.Handle, .5, {Size = self.Size})
	Engine.Tools:QuickTween(self.Detail, .5, {Size = self.DetailSize, Transparency = 1})
...
function Marble.new()
	...
	newMarble.Player = Engine.Tools:GetPlayer()
	...
	local CenterOfMass = Engine.Tools:GetCenterOfMass(Parts)

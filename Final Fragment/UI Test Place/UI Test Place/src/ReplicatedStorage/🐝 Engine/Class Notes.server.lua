...
NotificationService: Accept calls from random scripts. Instantiate the scroll frame and other classes.
...
__index = function(Table, Key)
	local NotificationService = _G.Engine.Services.NotificationService
	local CurrentFrame = NotificationService.CurrentFrame

...
function Beamer:Run()
	...
	self.Coroutine = coroutine.wrap(function()
		...
		while self.Running do
			...
			local BeamTween = Engine.Tools:QuickTween(self.BeamAttachment2, .5, {Position = Vector3.new(-self.Length,0,0)}, "Quint", "Out")
			...
			BeamTween = Engine.Tools:QuickTween(self.BeamAttachment2, .5, {Position = Vector3.new(0,0,0)}, "Quint", "In")
			BeamTween.Completed:Wait()
			self.Killing = false
